...
> Research documents providing theoretical foundations for Graphex design decisions.
...
- **[experiment-organization-module/](experiment-organization-module/)** - Config-driven experiment organization pattern (KGGen, AI2 Tango, PyKEEN)

## Usage

Research documents inform design decisions. When adding new research:
1. Document key findings and their implications for Graphex
2. Link to relevant sections in Product.md or Technical.md
3. Include citations

## Related

- [../Core/Meta.md](../Core/Meta.md) - Core documents informed by this research
